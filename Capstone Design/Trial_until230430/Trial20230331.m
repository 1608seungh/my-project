...
while norm(w_b) > 0.0002 || norm(v_b) > 0.00002 && i < 1000
...
% Link
% L1 = 0.057; L2 = 0.1036; L3 = 0.0975; L4 = 0.0069; L5 = 0.081; L6 = 0.02;
% 
% % (j)= [theta, d, a ,alpha]
