...
% Length of Link
L1 = 0.29; L2 = 0.832; L3 = 0.832; L4 = 0.731; L5 = 0.317; L6 = 0.414; % 10배 확장 스케일 

% Zero Position of Robot-Arm (기준이 되는 End-Effector의 현재 위치)
M = [[1 0 0; 0 1 0; 0 0 1], [0; L2+L3+L4+L5+L6; L1]; 0 0 0 1]; 
...
q1 = [0;0;0]; q2 = [0;0;L1]; q3 = [0;L2;L1];
q4 = [0;L2+L3;L1]; q5 = [0;L2+L3+L4;L1]; q6 = [0;L2+L3+L4+L5;L1];
...
L(2) = Link([0, 0, 0.832, 0]);
L(3) = Link([0, 0, 0.832, 0]);
L(4) = Link([0, 0, 0, pi/2]);
L(5) = Link([0, 1.048, 0, 0]);
L(6) = Link([0, 0.414, 0, pi/2]);

Robot = SerialLink(L);
Robot.name = 'Trial Robot 0323';
% 
% q1 = pi/2; q2 = pi/2; q3 = -pi/2; q4 = pi/2; q5 = 0; q6 = pi/2;
...
th_0 = [pi/2 pi/2 -pi/2 pi/2 0 pi/2];
