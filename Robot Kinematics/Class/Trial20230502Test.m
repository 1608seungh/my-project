...
% Zero Position
M01 = eye(4);
M02 = [eye(3), [0;0;0.1036]; 0 0 0 1];
M03 = [eye(3), [0;0;0.2011]; 0 0 0 1];
M04 = [eye(3), [-0.01;0;0.2280]; 0 0 0 1];
M05 = [eye(3), [-0.025;-0.081;0.228]; 0 0 0 1];
...
% Initial Angle 
i = 0;
th1 = 0; th2  = 0; th3 = pi/2; th4 = -pi/2; th5 = 0; th6 = 0;
...
while (norm(w_b) > 0.0005 || norm(v_b) > 0.00005) && i < 1000
    ...
    plot3(point0(1,:), point0(2,:), point0(3,:)) % 1st Joint
    ...
    plot3(point1(1,:), point1(2,:), point1(3,:)) % 2nd Joint
